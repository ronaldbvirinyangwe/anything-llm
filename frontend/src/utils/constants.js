...
export const AUTH_TOKEN = "chikoroai_authToken";
export const AUTH_TIMESTAMP = "chikoroaiauthTimestamp";
export const COMPLETE_QUESTIONNAIRE = "chikoroaicompleted_questionnaire";
