            ...
            style={{
              ...
              border:
                level === l
                  ...
                  : "2px solid var(--theme-sidebar-border)",
              background:
                level === l
            ...
            <button
              ...
              style={{
                ...
                border:
                  value === grade
                    ? "2px solid var(--theme-button-primary)"
                    : "1.5px solid var(--theme-sidebar-border)",
                background:
                  value === grade
                    ? "var(--theme-button-primary)"
                    : "var(--theme-bg-container)",
  ...
  if (editing) {
    return (
      <tr
        style={{
          background:
            "color-mix(in srgb, var(--theme-button-primary) 4%, transparent)",
        }}
      >
        <td
          style={{
        ...
        <td style={cellStyle}>
          <textarea
            style={{ ...editInputStyle, minHeight: 70 }}
            value={(draft.objectives || []).join("\n")}
            onChange={(e) =>
              setDraft({ ...draft, objectives: e.target.value.split("\n") })
            }
          />
        </td>
        <td style={cellStyle}>
          <textarea
            ...
            onChange={(e) =>
              setDraft({ ...draft, activities: e.target.value.split("\n") })
            }
          />
        </td>
        <td style={cellStyle}>
          <textarea
            style={{ ...editInputStyle, minHeight: 50 }}
            value={(draft.resources || []).join("\n")}
            onChange={(e) =>
              setDraft({ ...draft, resources: e.target.value.split("\n") })
            }
          />
        </td>
        <td style={cellStyle}>
    ...
    <tr
      ...
      onMouseEnter={(e) =>
        (e.currentTarget.style.background =
          "color-mix(in srgb, var(--theme-button-primary) 3%, transparent)")
      }
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Generate a detailed, week-by-week scheme of work — then edit any
            cell directly before exporting.
          </p>
        </div>

        {/* Two-column layout */}
        <div
          className="sow-layout"
          style={{
            display: "grid",
        ...
        >
          ...
          >
              ...
              >
                ...
                >
                  ...
                  <GradeSelector
                    ...
                    onChange={(g) => setFormField("grade", g)}
                  />
                </div>
                ...
                >
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormField("weeks", parseInt(e.target.value) || "")
                    }
                    style={inputStyle}
                  />
                </div>
                ...
                {totalWeeks > 0 && (
                  ...
                  >
                    ...
                    {holidayWeeks.length > 0 && (
                      ...
                      >
                        {activeWeekCount} teaching week
                        {activeWeekCount !== 1 ? "s" : ""} ·{" "}
                        {holidayWeeks.length} holiday week
                        {holidayWeeks.length !== 1 ? "s" : ""}
                      </p>
                    )}
                  </div>
                )}
                ...
                <button
                  ...
                  style={{
                    ...
                    fontSize: 14,
                    cursor:
                      isLoading || !formData.grade ? "not-allowed" : "pointer",
                    border: "none",
                    fontFamily: "inherit",
                    width: "100%",
                    ...
                    <>
                      <div
                        style={{
                          ...
                          borderTopColor: "#fff",
                          borderRadius: "50%",
                          animation: "sow-spin .8s linear infinite",
                        }}
                      />{" "}
                      Generating…
                    </>
            ...
            <div
              style={{
                background:
                  "color-mix(in srgb, var(--theme-button-primary) 8%, var(--theme-bg-secondary))",
                border:
                  "1px solid color-mix(in srgb, var(--theme-button-primary) 20%, var(--theme-sidebar-border))",
                borderRadius: 12,
                padding: "14px 16px",
              }}
            >
              ...
              >
                <strong style={{ color: "var(--theme-button-primary)" }}>
                  💡 Tip:
                </strong>{" "}
                Upload your official ZIMSEC or Cambridge syllabus PDF for the
                most accurate topic sequencing. Click any row in the table to
                edit it.
              </p>
            </div>
          </div>
          ...
          <div style={{ minHeight: 500 }}>
              ...
              >
                <div
                  style={{
                    ...
                    borderRadius: "50%",
                    animation: "sow-spin 1s linear infinite",
                    marginBottom: 18,
                  }}
                />
                <p
                ...
                >
                  Mapping out your term schedule…
                </p>
                {syllabusFile && (
                  <p
                    style={{
              ...
              >
                ...
                >
                  ...
                  >
                    {[
                      {
                        label: `${scheme.weeks?.length || 0} Weeks`,
                        color: "var(--theme-button-primary)",
                      },
                      { label: `${scheme.grade}`, color: "#7c3aed" },
                      { label: scheme.term, color: "#059669" },
                      ...(scheme.curriculum
                        ? [{ label: scheme.curriculum, color: "#0891b2" }]
                        : []),
                    ].map(({ label, color }) => (
                      <span
                        key={label}
                ...
                >
                  <FiEdit2 size={12} /> Click any row to edit it inline, then
                  save.
                </div>
            ...
            {!scheme && !isLoading && !error && (
              ...
              >
                ...
                >
                  Fill out the details on the left and hit Generate to create a
                  full scheme you can edit and export.
                </p>
              </div>
            )}
          </div>
