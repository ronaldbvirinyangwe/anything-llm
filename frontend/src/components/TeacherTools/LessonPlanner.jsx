...
import logoUrl from "@/media/logo/logo.jpg";
...
const cleanMarkdown = (text) => {
  ...
  cleaned = cleaned.replace(
    /It's structured in Markdown format for readability\.\s*/gi,
    ""
  );
  return cleaned.trim();
};
      ...
      generatePlan: async () => {
        ...
        try {
          ...
          const response = await axios.post(
            `${API_BASE}/system/teacher-tools/generate-lesson-plan`,
            formData,
            { headers }
          );
...
export default function LessonPlanner() {
  ...
  const saveAsPowerPoint = () => {
    ...
    slide1.addText(`${formData.grade}   |   Duration: ${formData.duration}`, {
      x: 1,
      y: "60%",
      w: "80%",
      h: 0.5,
          ...
          if (block.type === "text") {
            ...
            const tableData = block.rows.map((row, rIdx) =>
              row.map((cellText) => ({
                ...
                options: {
                  fill:
                    rIdx === 0 ? ACCENT : rIdx % 2 === 0 ? "F8FAFC" : "FFFFFF",
            ...
            const colWidths = Array(tableData[0].length).fill(
              9 / tableData[0].length
            );
  ...
  const isCustomDuration =
    !STANDARD_DURATIONS.includes(formData.duration) || formData.duration === "";
      ...
      >
        ...
        >
          ...
          >
            ...
            engaging lesson plan for you in seconds.
          </p>
        </div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <option value="80 minutes (Double Period)">
                      80 minutes (Double Period)
                    </option>
                  ...
                  {isCustomDuration && (
                    <input
                      ...
                      style={{
                        ...inputStyle,
                        marginTop: 6,
                        border: "1.5px dashed var(--theme-button-primary)",
                      }}
                    />
                  )}
                </div>
          ...
          <div style={{ minHeight: 500 }}>
            ...
            {isLoading && (
              ...
              >
                ...
                >
                  Crafting your perfect lesson plan…
                </p>
              </div>
            )}
