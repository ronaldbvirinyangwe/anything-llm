...
export const CHECKLIST_UPDATED_EVENT = "chikoroai_checklist_updated";
export const CHECKLIST_STORAGE_KEY = "chikoroai_checklist_completed";
export const CHECKLIST_HIDDEN = "chikoroai_checklist_dismissed";
