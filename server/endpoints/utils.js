 ...
 * as well as build features in ChikoroAI directly for a specific model or capabilities.
 *
...
/**
 * Returns the user agent for the ChikoroAI deployment.
 * @returns {string} The user agent.
 */
function getChikoroAIUserAgent() {
  const version = getDeploymentVersion() || "unknown";
  return `ChikoroAI/${version}`;
}
